/datum/species/xenomorph/get_bodytype(var/mob/living/carbon/H)
	return "Xenomorph"

/datum/species/xenomorph/can_understand(var/mob/other)
	if(istype(other,/mob/living/carbon/alien/xenolarva))
		return 1
	return 0
...
/datum/species/xenomorph/handle_environment_special(var/mob/living/carbon/human/H)
...
/datum/species/xenomorph/disarm_attackhand(var/mob/living/carbon/human/attacker, var/mob/living/carbon/human/target)
