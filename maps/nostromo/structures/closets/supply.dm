...
/decl/closet_appearance/secure_closet/nostromo/cargo/quartmaster
	extra_decals = list(
...
/obj/structure/closet/secure_closet/decktech
	...
	closet_appearance = /decl/closet_appearance/secure_closet/nostromo/cargo/decktech
...
/obj/structure/closet/secure_closet/quartermaster_nostromo
	name = "quartermaster's locker"
	req_access = list(access_qm)
	closet_appearance = /decl/closet_appearance/secure_closet/nostromo/cargo/quartmaster

/obj/structure/closet/secure_closet/quartermaster_nostromo/WillContain()
	return list(
		/obj/item/device/radio/headset/nostromo_quartermaster,
		/obj/item/device/radio/headset/nostromo_quartermaster/alt,
		/obj/item/clothing/gloves/thick,
