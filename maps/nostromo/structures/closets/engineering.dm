...
/obj/structure/closet/secure_closet/engineering_chief_nostromo
	name = "chief engineer's locker"
	req_access = list(access_ce)
	closet_appearance = /decl/closet_appearance/secure_closet/engineering/ce

/obj/structure/closet/secure_closet/engineering_chief_nostromo/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/engineering_nostromo
	name = "engineer's locker"
	req_access = list(access_engine_equip)
	closet_appearance = /decl/closet_appearance/secure_closet/engineering

/obj/structure/closet/secure_closet/engineering_nostromo/WillContain()
	return list(
		/obj/item/clothing/accessory/storage/brown_vest,
		/obj/item/weapon/storage/belt/utility/full,
		/obj/item/device/radio/headset/headset_eng,
