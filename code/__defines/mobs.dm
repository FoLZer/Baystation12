...
#define SPECIES_ZOMBIE_TAJARA 	"Zombie Tajara"
#define SPECIES_ZOMBIE_SKRELL  	"Zombie Skrell"
#define SPECIES_ZOMBIE_UNATHI  	"Zombie Unathi"
#define SPECIES_SPIDER       "Spider"
