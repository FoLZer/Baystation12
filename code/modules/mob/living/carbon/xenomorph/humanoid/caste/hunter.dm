/mob/living/carbon/human/xenomorph/humanoid/hunter
	name = "alien hunter"
	caste = "h"
	maxHealth = 180
	health = 180
...
/mob/living/carbon/human/xenomorph/humanoid/hunter/Initialize()
...
/mob/living/carbon/human/xenomorph/humanoid/hunter/handle_environment()
	if(move_intent.name == "Run" || resting)
		..()
	else
		adjustToxLoss(-heal_rate)

/mob/living/carbon/human/xenomorph/humanoid/hunter/handle_hud_icons_health()
	if (healths)
		if (stat != DEAD)
			switch(health)
				if(150 to INFINITY)
...
//Hunter verbs
/*
/mob/living/carbon/human/xenomorph/humanoid/hunter/verb/invis()
...
/mob/living/carbon/human/xenomorph/humanoid/hunter/toggle_leap(message = 1)
...
/mob/living/carbon/human/xenomorph/humanoid/hunter/ClickOn(atom/A, params)
...
/mob/living/carbon/human/xenomorph/humanoid/hunter/leap_at(atom/A)
...
/mob/living/carbon/human/xenomorph/humanoid/hunter/leap_end()
	leaping = FALSE
	update_icons()

/mob/living/carbon/human/xenomorph/humanoid/hunter/throw_impact(atom/hit_atom, datum/thrownthing/throwingdatum)
	if(!leaping)
		return ..()
	...
	if(isliving(hit_atom))
		...
		addtimer(CALLBACK(src, .proc/reset_cooldown), pounce_cooldown_time)
...
/mob/living/carbon/human/xenomorph/humanoid/hunter/proc/reset_cooldown()
	pounce_cooldown = FALSE

#undef MAX_ALIEN_LEAP_DIST

/mob/living/carbon/human/xenomorph/humanoid/hunter/movement_delay()
