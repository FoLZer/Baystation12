...
/mob/living/carbon/human/xenomorph/proc/updatePlasmaDisplay()
	if(visual_counter)
...
/mob/living/carbon/human/xenomorph/larva/updatePlasmaDisplay()
	return

/mob/living/carbon/human/xenomorph/facehugger/updatePlasmaDisplay()
	return
