...
/obj/structure/alien
	...
	var/facehuggers_control_type = FACEHUGGERS_DYNAMIC_AI
...
/obj/structure/alien/resin
	...
	icon = 'icons/obj/structures/alien/resin_wall.dmi'
	icon_state = "box"
	density = TRUE
	opacity = TRUE
	anchored = TRUE
...
/obj/structure/alien/resin/membrane
	...
	icon = 'icons/obj/structures/alien/resin_membrane.dmi'
	opacity = FALSE
	health = 160
	resintype = "membrane"
...
/obj/structure/alien/resin/hitby(atom/movable/AM, datum/thrownthing/throwingdatum)
	...
	playsound(src, 'sound/effects/attackblob.ogg', 100)
...
/obj/structure/alien/weeds/Initialize(mapload, node)
	...
	if(icon == initial(icon))
		switch(rand(1, 3))
			if(1)
				icon = 'icons/obj/structures/alien/weeds1.dmi'
			if(2)
				icon = 'icons/obj/structures/alien/weeds2.dmi'
			if(3)
				icon = 'icons/obj/structures/alien/weeds3.dmi'
	pixel_x = -4
...
/obj/structure/alien/weeds/LateInitialize()
...
/obj/structure/alien/weeds/attackby(obj/item/weapon/W, mob/user)
	...
	if(iswelder(W))
		damage = 15
		playsound(src, 'sound/items/Welder.ogg', 100)
...
/obj/structure/alien/weeds/node/Initialize(mapload)
	icon = 'icons/obj/structures/alien/weednode.dmi'
	. = ..(mapload, src)
...
/obj/effect/alien/acid/LateInitialize()
...
/obj/structure/alien/egg/attack_ghost(mob/living/user)
	...
	switch(status)
		...
		if(GROWING)
			...
			return
		if(GROWN)
			var/mob/living/carbon/human/xenomorph/facehugger/FH = new /mob/living/carbon/human/xenomorph/facehugger(get_turf(src))
			FH.key = user.key
...
/obj/structure/alien/air_plant/Initialize()
	. = ..()
	START_PROCESSING(SSobj, src)
...
/obj/structure/alien/air_plant/healthcheck()
	if(health <= 0)
		qdel(src)
