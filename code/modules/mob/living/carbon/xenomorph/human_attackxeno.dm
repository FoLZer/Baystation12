...
----------------------------------------*/
/mob/living/carbon/human/xenomorph/UnarmedAttack(atom/A)
	..()
	A.attack_alien(src)

// Baby aliens
/mob/living/carbon/human/xenomorph/facehugger/UnarmedAttack(atom/A)
	A.attack_facehugger(src)

/atom/proc/attack_facehugger(mob/user)
	return

/mob/living/carbon/human/xenomorph/larva/UnarmedAttack(atom/A)
	A.attack_larva(src)

/atom/proc/attack_larva(mob/user)
	return

/mob/living/carbon/human/xenomorph/larva/get_unarmed_attack()
	var/retDam = 1
...
/mob/living/carbon/human/attack_larva(mob/living/carbon/human/xenomorph/larva/attacker)
