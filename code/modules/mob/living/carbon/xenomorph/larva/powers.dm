...
/mob/living/carbon/human/xenomorph/larva/verb/evolve()
	set name = "Evolve"
	...
	if(amount_grown >= max_grown)	//TODO ~Carn
		...
		var/mob/living/carbon/human/xenomorph/humanoid/new_xeno
		switch(alien_caste)
			if("Hunter")
				new_xeno = new /mob/living/carbon/human/xenomorph/humanoid/hunter(loc)
			if("Sentinel")
				new_xeno = new /mob/living/carbon/human/xenomorph/humanoid/sentinel(loc)
			if("Drone")
				new_xeno = new /mob/living/carbon/human/xenomorph/humanoid/drone(loc)
