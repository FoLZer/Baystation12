...
var/list/advance_cures = 	list(
									/datum/reagent/nutriment, /datum/reagent/sugar, /datum/reagent/drink/juice/orange,
									/datum/reagent/spaceacillin, /datum/reagent/kelotane, /datum/reagent/ethanol,
									/datum/reagent/leporazine, /datum/reagent/synaptizine, /datum/reagent/lipozine,
									/datum/reagent/silver, /datum/reagent/gold, /datum/reagent/toxin/phoron
								)
...
/proc/AdminCreateVirus(mob/user)
	...
	if(D.symptoms.len > 0)
		...
		var/new_name = sanitizeSafe(input(user, "Name your new disease.", "New Name"), MAX_LNAME_LEN)
		...
		for(var/mob/living/carbon/human/H in shuffle(GLOB.human_mob_list))
